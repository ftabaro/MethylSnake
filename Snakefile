...
rule trim:
    ...
    input:
      [ os.path.join(config["raw_reads_folder"], "{sample}_1.fastq.gz"), os.path.join(config["raw_reads_folder"], "{sample}_2.fastq.gz") ]
    output:
      os.path.join(config["trimmed_reads_folder"], "{sample}_1_val_1.fq.gz"),
      os.path.join(config["trimmed_reads_folder"], "{sample}_1.fastq.gz_trimming_report.txt"),
      os.path.join(config["trimmed_reads_folder"], "{sample}_2_val_2.fq.gz"),
      os.path.join(config["trimmed_reads_folder"], "{sample}_2.fastq.gz_trimming_report.txt"),
    conda:
